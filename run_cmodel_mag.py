...
#%%
#ugriz  filters
filter_one = "cModelMag_i"
filter_two = "cModelMag_r"
dot_size = 0.35
bins = 100
magnitude_limit = 18
mag_lim_sdss = 23
...
#%%
#if filter_one == "cModelMag_u":
#    filter_two = "cModelMag_g"
#elif filter_one == "cModelMag_g":
#    filter_two = "cModelMag_r"
#elif filter_one == "cModelMag_r":
#    filter_two = "cModelMag_i"
#elif filter_one == "cModelMag_i":
#    filter_two = "cModelMag_z"
#else:
#    raise Exception("Invalid Filter, choose one of cModelMag_u,cModelMag_g,cModelMag_r,cModelMag_i,cModelMag_z ")
#%%
t_data_PLANCK,colnames_PLANCK = op.open_planck_data()
print("PLANCK OPEN")

#%%
def loop_through_planck_cModel(table,f,length,mag_limit,z_lim):
    ...
    for i in np.arange(length):
        ...
        xid = SDSS.query_region(galatic_pos, spectro = True , radius = 2.5*u.arcmin , specobj_fields=['Z','class', 'BestObjID'], photoobj_fields=['ra','dec','cModelMag_u','cModelMag_g','cModelMag_r','cModelMag_i'])
...
def loop_through_sdss_gal(f, num_req, mag_limit, width):
    ...
    while len(sdss_gal) < num_req:
        ...
        xid = SDSS.query_region(galatic_pos, spectro = True , radius = width*u.arcmin , specobj_fields=['Z','class'], photoobj_fields=['ra','dec','cModelMag_u','cModelMag_g','cModelMag_r','cModelMag_i'])
...
hdulist_SDSS = fits.open('/Users/daniel/Documents/Bsc_Project/Skyserver_SQL3_7_2019 6_22_21 PM.fits')
...
with warnings.catch_warnings():
    ...
    #SDSS_DATA = loop_through_planck_cModel(t_data_PLANCK,filter_one,number_of_compact_sources,magnitude_limit,z_lim)
    #length = len(SDSS_DATA[0])
    #SDSS_DATA[0].write("Data/sdss_galaxies_data_cModelsian_{}___lengthGalaxies_{}".format(filter_one,length), format = 'ascii')
    
    SDSS_DATA = [Table.read("/Users/daniel/Documents/Bsc_Project/Local_Python_Code/Data/sdss_galaxies_data_cModelsian_cModelMag_i___lengthGalaxies_1706", format = 'ascii')]
    length = len(SDSS_DATA[0])
...
#    print("HIEEEE")
    ...
    #sdss_galaxies[0].write("Data/sdss_galaxies_data_cModelsian_sdssgal_{}___lengthGalaxies_{}".format(filter_one,len(sdss_galaxies)), format = 'ascii')
...
plt.savefig("Plots/Colour_Magnitude_cModelsian_plot_contour_SDSS_GALAXIES_{}_{}___length_{}.png".format(filter_one,filter_two,length))
